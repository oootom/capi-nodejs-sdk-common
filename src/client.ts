...
import { cgiRequest, cgiRequestWithSign3 } from './request';
...
export class CapiClient {
  ...
  private async doRequest(action: string, req: Record<string, any>, options: RequestOptions): Promise<Response> {
  ...
  private async doRequestWithSign(action: string, req: Record<string, any>, options: RequestOptions): Promise<Response> {
    let res = {};
    try {
  ...
  private async doRequestWithSign3(action: string, req: Record<string, any>, options: RequestOptions): Promise<Response> {
    let res = {};
    try {
      const credential = this.getCredential();
      res = await cgiRequestWithSign3({
